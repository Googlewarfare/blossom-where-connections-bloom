...
const Activity = () => {
  ...
  const ActivityCard = ({ user: activityUser, icon: Icon, iconColor }: { 
    user: ActivityUser; 
    icon: any; 
    iconColor: string;
  }) => (
      ...
      <div className="container mx-auto max-w-4xl p-4 py-8">
        ...
        <div className="flex items-center gap-4 mb-6">
          ...
          <div>
            ...
            <p className="text-muted-foreground">See who's interested in you</p>
          </div>
        </div>
          ...
          <TabsList className="grid w-full grid-cols-3">
            <TabsTrigger value="matches" className="gap-2">
              ...
              {recentMatches.length > 0 && (
                <Badge variant="secondary" className="ml-1">{recentMatches.length}</Badge>
              )}
            </TabsTrigger>
            ...
            <TabsTrigger value="views" className="gap-2">
              ...
              {profileViews.length > 0 && (
                <Badge variant="secondary" className="ml-1">{profileViews.length}</Badge>
              )}
            </TabsTrigger>
          </TabsList>
            ...
            <div className="space-y-3">
              {profileViews.length === 0 ? (
                <Card className="p-12 text-center">
                  ...
                  <h3 className="text-lg font-semibold mb-2">No profile views</h3>
                  <p className="text-muted-foreground mb-4">
