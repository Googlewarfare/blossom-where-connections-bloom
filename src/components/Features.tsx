  ...
  return <section className="py-20 px-4 bg-background">
      <div className="container mx-auto max-w-6xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
          ...
          return <Card key={index} className="p-8 border-2 hover:border-primary/50 transition-smooth shadow-card hover:shadow-soft group cursor-pointer bg-card/50 backdrop-blur-sm">
